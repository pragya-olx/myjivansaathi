...
?>
    ...
    <a href="/detail.php?id=<?php echo $row['id'];?>">
        <div style ="padding: 5px; margin : 5px;float: left; background-color: lightgreen; height:100px; width:100px;">
            <p> <img style="height: 80px;" src="assets/girl.png"></img></p>
        </div>


        <div  style ="padding: 5px; float:right; margin: 5px;background-color: lightyellow; height:100px;width: 1157px;"">
